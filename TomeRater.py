...
class TomeRater:
    def __init__(self):
        ...
        self.books = {}
        #Maps book object to number of users have have read it
    ...
    def most_read_book(self):
        ...
        print("Most read book is {name} with a read count of {count}.".format(name=highest_name, count=highest_read_count))
    ...
    def highest_rated_book(self):
        ...
        print("Book with highest rating is {name} with average rating of {rating}".format(name=highest_avg_name, rating=highest_avg_rating))
    ...
    def most_positive_user(self):
        ...
        print("Most positive user is {name} with average rating of {rating}".format(name=highest_name, rating=highest_avg_rating))
    ...
    def get_most_read_book(self):
        ...
        print("Book with highest read count is {name}".format(name=high_read_name))
